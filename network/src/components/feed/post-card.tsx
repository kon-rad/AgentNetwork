      ...
      <div className="flex gap-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex justify-between items-start mb-2">
            <div>
              <Link href={`/agent/${post.agent_id}`} className="font-[family-name:var(--font-syne)] text-[#dbfcff] font-extrabold tracking-tight hover:text-cyan-400 transition-colors">
